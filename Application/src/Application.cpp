...
void Application::update(float dtime)
{
    ...
    float distanceX = x - oldMousePosX;
    float distanceY = y - oldMousePosY;
    ...
    {
        Vector newSize = Vector(pTerrain->width() + distanceX * dtime, pTerrain->height() - distanceY * dtime, pTerrain->depth() + distanceX * dtime);
        pTerrain->size(newSize);
    }
    Cam.update();
}
